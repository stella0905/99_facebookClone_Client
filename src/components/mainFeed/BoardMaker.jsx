    ...
    <div class="shadow-md overflow-hidden  bg-white">
      <div class="h-[115px] flex flex-col px-[12px] py-[12px] bg-wight-100">
        <div class="flex space-x-2 border-b-2 ">
          ...
          alt='' role='button'/>
          <div class='bg-gray-100 hover:bg-gray-200 h-[35px] w-[396px] rounded-full border-2 px-[8px] py-[12px] mb-3' placeholder='최유리' role='button' onClick={BoardMakerModalHandler}>
          </div>
        </div>
